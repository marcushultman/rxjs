/** @prettier */
import { ObservableInput, ObservableInputTuple, OperatorFunction, MonoTypeOperatorFunction, SchedulerLike } from '../types.ts';
import { operate } from '../util/lift.ts';
import { concatAll } from './concatAll.ts';
import { internalFromArray } from '../observable/fromArray.ts';
